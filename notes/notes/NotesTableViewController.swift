...
class NotesTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        notes.append(Note(title: "Note 1", text: "This is a note"))
        notes.append(Note(title: "Note 2", text: "This is another note"))
        notes.append(Note(title: "Note 3", text: "This is a bear.  Or just a note."))
